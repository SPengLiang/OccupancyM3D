...
class DataAugmentor(object):
    ...
    def random_image_distort(self, data_dict=None, config=None):
        if data_dict is None:
            return partial(self.random_image_distort, config=config)
        data_dict['images'] = AugPhotometricDistort(data_dict['images'])
        return data_dict
